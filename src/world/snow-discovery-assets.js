...
// Flat-shaded parts merged into one draw call. A per-vertex glow lets lit
// windows and moonlit ice share a material with the timber and steel around them.
export class SnowDiscoveryParts {
  ...
  // A tapered prism from a to b; radii are at a and b respectively.
...
function cabin() {
  ...
  // The carriage rolls on the rope at the origin; the cabin travels along +z
  // and its hanger swings out along +x, clear of the pylon saddles.
